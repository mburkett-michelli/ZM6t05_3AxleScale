...
Description:
This file provides RPN entry functionality for the ZM indicator.
...
--[[
Description:
-- Function that gets called when an RPN event for the F2 key gets called
    By default RPN does nothing for this key.
Parameters:
  enteredValue = the value that was entered
...
-- F2 doesn't have an RPN function in 2.2.0.0 firmware
--function awtxReq.keypad.onRpnF2(enteredValue)
  -- Default functionality.
  -- Redefine function to change functionality
--  awtx.display.writeLine("Cant", 500)
--end
...
--[[
Description:
-- Function that gets called when an RPN event for the F3 key gets called
    By default RPN does nothing for this key.
Parameters:
  enteredValue = the value that was entered
...
-- F3 doesn't have an RPN function in 2.2.0.0 firmware
--function awtxReq.keypad.onRpnF3(enteredValue)
  -- Default functionality.
  -- Redefine function to change functionality
--  awtx.display.writeLine("Cant", 500)
--end
...
--[[
Description:
-- Function that gets called when an RPN event for the F4 key gets called
    By default RPN does nothing for this key.
Parameters:
  enteredValue = the value that was entered
...
-- F4 doesn't have an RPN function in 2.2.0.0 firmware
--function awtxReq.keypad.onRpnF4(enteredValue)
  -- Default functionality.
  -- Redefine function to change functionality
--  awtx.display.writeLine("Cant", 500)
--end
...
--[[
Description:
-- Function that gets called when an RPN event for the F5 key gets called
    By default RPN does nothing for this key.
Parameters:
  enteredValue = the value that was entered
...
-- F5 doesn't have an RPN function in 2.2.0.0 firmware
--function awtxReq.keypad.onRpnF5(enteredValue)
  -- Default functionality.
  -- Redefine function to change functionality
--  awtx.display.writeLine("Cant", 500)
--end
...
-- F1-F5 and SETUP keys don't have RPN functionality in version 2.2.0.0 firmware
--  elseif tostring(lastKey) == "F1" then
--    awtxReq.keypad.onRpnF1(enteredValue)
--  elseif tostring(lastKey) == "F2" then
--    awtxReq.keypad.onRpnF2(enteredValue)
--  elseif tostring(lastKey) == "F3" then
--    awtxReq.keypad.onRpnF3(enteredValue)
--  elseif tostring(lastKey) == "F4" then
--    awtxReq.keypad.onRpnF4(enteredValue)
--  elseif tostring(lastKey) == "F5" then
--    awtxReq.keypad.onRpnF5(enteredValue)
